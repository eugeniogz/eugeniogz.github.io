...
* **Armazenamento Local:** Todos os seus textos, classificações, tags e metadados são salvos localmente, apenas no seu dispositivo.
...
* Ao configurar uma **Senha de Backup** no aplicativo, o arquivo enviado ao seu Google Drive será criptografado usando o padrão de segurança avançada **AES**.
...
1. Conceder permissão para que o App crie e modifique arquivos de backup no seu próprio Google Drive.

1. Vincular de forma anônima e segura a sua conta para gerenciar assinaturas premium entre seus dispositivos (via RevenueCat).

* O App **não** lê arquivos de outros aplicativos no seu Google Drive, **não** acessa seus e-mails e **não** coleta sua lista de contatos.
...
* Os textos são enviados à API do Google Gemini de forma anônima.

* Utilizamos a API na modalidade paga ("Pay-tier"). Segundo os termos do Google, **os seus dados não são usados para treinar os modelos de inteligência artificial do Google**.
...
* **Firebase Crashlytics & Analytics:** Coleta relatórios de falhas do aplicativo e dados de uso anônimos (como cliques em botões) para nos ajudar a corrigir erros e melhorar a experiência. Eles não têm acesso aos textos do seu diário.
...
* Excluir localmente os seus backups automáticos.
